...
export default function Profile() {
  ...
  const [activeCard, setActiveCard] = useState('emergency');
            ...
            {user.smartTagId ? (
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px', background: 'rgba(255,255,255,0.01)', padding: '24px 20px', borderRadius: '24px', border: '1px solid var(--border)', overflow: 'hidden', minWidth: '320px' }}>
                  ...
                  {/* Switcher Tab */}
                  <div style={{ display: 'flex', gap: '0.5rem', background: 'rgba(255,255,255,0.03)', padding: '6px', borderRadius: '50px', border: '1px solid var(--border)', width: 'fit-content' }}>
                    <button 
