...
import { Car, Mail, Lock, ChevronRight, ShieldCheck } from 'lucide-react';
        ...
        <div style={{ maxWidth: '440px', width: '100%', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginBottom: '3rem', textAlign: window.innerWidth < 768 ? 'center' : 'left' }}>
            ...
            <p style={{ color: 'var(--muted)', fontSize: '1.1rem' }}>
              {mode === 'login' ? 'Enter your credentials to access your vault.' : 'Setup your secure vehicle profile.'}
            </p>
          </div>
          ...
          {mode === 'login' ? (
             <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
               ...
               <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '-0.5rem', marginBottom: '0.5rem' }}>
                  <button 
                    type="button" 
                    onClick={() => toast.error("Password recovery coming soon.")} 
